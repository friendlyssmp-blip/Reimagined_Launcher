...
- **Link directo:**
  `https://raw.githubusercontent.com/friendlyssmp-blip/Reimagined_Launcher/main/dist/Reimagined-Setup-1.0.8.exe`
- **O en GitHub:** abre el repo - carpeta `dist` - `Reimagined-Setup-1.0.8.exe` - boton Download.
...
```powershell
Get-FileHash "C:\Users\TU_USUARIO\Downloads\Reimagined-Setup-1.0.8.exe" -Algorithm SHA256
```
...
1. Doble clic en `Reimagined-Setup-1.0.8.exe`
